...
with col2:
    ...
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Daniel Sepulveda Herrera</h3>', unsafe_allow_html=True)
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Andres Felipe Macias Lopez</h3>', unsafe_allow_html=True)
